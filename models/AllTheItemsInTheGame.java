...
public class AllTheItemsInTheGame {
    ...
    static {
        ...
        tempPlants.put(311, new Plant(311, new Point(0, 0), "Rhubarb", 220, false, -1, -1, "Rhubarb Seeds", 0, 0, 13, Season.SPRING, new int[]{2, 2, 2, 3, 4}, false, false, false,0));
        tempPlants.put(312, new Plant(312, new Point(0, 0), "Strawberry", 120, true, 50, 22, "Strawberry Seeds", 0, 0, 8, Season.SPRING, new int[]{1, 1, 2, 2, 2}, true, false, false,4));
        ...
        tempPlants.put(315, new Plant(315, new Point(0, 0), "Blueberry", 50, true, 25, 11, "Blueberry Seeds", 0, 0, 13, Season.SUMMER, new int[]{1, 3, 3, 4, 2}, true, false, false,4));
        ...
        tempPlants.put(318, new Plant(318, new Point(0, 0), "Hot Pepper", 40, true, 13, 5, "Pepper Seeds", 0, 0, 5, Season.SUMMER, new int[]{1, 1, 1, 1, 1}, true, false, false,3));
        tempPlants.put(319, new Plant(319, new Point(0, 0), "Melon", 250, true, 113, 50, "Melon Seeds", 0, 0, 12, Season.SUMMER, new int[]{1, 2, 3, 3, 3}, false, false, false,0));
        ...
        tempPlants.put(323, new Plant(323, new Point(0, 0), "Starfruit", 750, true, 125, 56, "Starfruit Seeds", 0, 0, 13, Season.SUMMER, new int[]{2, 3, 2, 3, 3}, false, false, false,0));
        ...
        tempPlants.put(334, new Plant(334, new Point(0, 0), "Cranberries", 75, true, 38, 17, "Cranberry Seeds", 0, 0, 7, Season.FALL, new int[]{1, 2, 1, 1, 2}, true, false, false,5));
        ...
        tempPlants.put(337, new Plant(337, new Point(0, 0), "Grape", 80, true, 38, 17, "Grape Starter", 0, 0, 10, Season.FALL, new int[]{1, 1, 2, 3, 3}, true, false, false,3));
        tempPlants.put(338, new Plant(338, new Point(0, 0), "Pumpkin", 320, false, -1, -1, "Pumpkin Seeds", 0, 0, 13, Season.FALL, new int[]{1, 2, 3, 4, 3}, false, false, false,0));
        ...
        tempPlants.put(341, new Plant(341, new Point(0, 0), "Powdermelon", 60, true, 63, 28, "Powdermelon Seeds", 0, 0, 7, Season.WINTER, new int[]{1, 2, 1, 2, 1}, true, false, false,0));
        tempPlants.put(342, new Plant(342, new Point(0, 0), "Ancient Fruit", 550, false, -1, -1, "Ancient Seeds", 0, 0, 28, Season.OTHER_THAN_WINER, new int[]{2, 7, 7, 7, 5}, true, false, false,7));
