...
//        tempItems.put(11, new Item("SHIPPING BIN", 11 ,20 , 0 ,1));
        ...
        tempItems.put(36, new Item("Wood",36,2,0,1,new Texture("Trees/Wood.png")));
       ...
       // tempItems.put(59, new  ) nemidanam
        ...
        tempItems.put(380, new Item("Quartz",380,2,0,1,new Texture("Mineral/Quartz.png")));
        tempItems.put(381, new Item("Earth Crystal",381,2,0,1,new Texture("Mineral/Earth_Crystal.png")));
        tempItems.put(382, new Item("Frozen Tear",382,2,0,1,new Texture("Mineral/Frozen_Tear.png")));
        tempItems.put(383, new Item("Fire Quartz",383,2,0,1,new Texture("Mineral/Fire_Quartz.png")));
        tempItems.put(384, new Item("Emerald",384,2,0,1,new Texture("Mineral/Soapstone.png")));
        tempItems.put(385, new Item("Aquamarine",385,2,0,1,new Texture("Mineral/Lunarite.png")));
        tempItems.put(386, new Item("Ruby",386,2,0,1,new Texture("Mineral/Dolomite.png")));
        tempItems.put(387, new Item("Amethyst",387,2,0,1,new Texture("Mineral/Star_Shards.png")));
        tempItems.put(388, new Item("Topaz",388,2,0,1,new Texture("Mineral/Mudstone.png")));
        tempItems.put(389, new Item("Jade",389,2,0,1,new Texture("Mineral/Jasper.png")));
        tempItems.put(390, new Item("Diamond",390,2,0,1,new Texture("Mineral/Obsidian.png")));
        tempItems.put(391, new Item("Prismatic Shard",391,2,0,1,new Texture("Mineral/Thunder_Egg.png")));
        tempItems.put(392, new Item("Copper Ore",392,2,0,1,new Texture("Mineral/Pyrite.png")));
        tempItems.put(393, new Item("Iron Ore",393,2,0,1,new Texture("Mineral/Nekoite.png")));
        tempItems.put(394, new Item("Gold Ore",394,2,0,1,new Texture("Mineral/Marble.png")));
        tempItems.put(395, new Item("Iridium Ore",395,2,0,1,new Texture("Mineral/Lemon_Stone.png")));
        tempItems.put(396, new Item("Coal",396,2,0,1,new Texture("Mineral/Bixite.png")));
