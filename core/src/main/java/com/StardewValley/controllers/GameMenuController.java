...
import com.StardewValley.model.enums.commands.GameMenu;
import com.StardewValley.model.things.Food.Food;
import com.StardewValley.model.things.Item;
import com.StardewValley.model.things.machines.Machine;
import com.StardewValley.model.things.machines.Operation;
...
//            return new Result<>(false, "There is No NPC Around You!");
    ...
    public void nextDay() {
        com.StardewValley.model.Map map = App.currentGame.map;
    ...
    public Result<String> handleNewGame(Matcher matcher, Scanner scanner) {
        ...
        for (int i = 0; i < players.size() + 1; i++) {
            ...
            Matcher mapMatcher = GameMenu.gamemap.getMatcher(input);
...
// انرژی نهایی پس از رسیدن به مقصد
    ...
    public void checkEnteringMenu(){
        ...
        if (currentGame.map.farms[turn].lastTileType == TileType.DOOR) {
            com.StardewValley.model.Map map = currentGame.map;
...
*/
    ...
    public void setUpNextDay() {
        ...
        for (Plant plant : App.getCurrentGame().getPlants()) {
            ...
            if (App.getCurrentGame().tomarrowsWeather.equals(com.StardewValley.model.enums.Weather.RAINY))
                plant.setHasBeenWatered(true);
            else
    ...
    public void setMap(){
        ...
        for(int i=0; i < playerNUmber; i++){
            ...
            for (int j=0;i<rand.nextInt(10,20);i++){
                ...
                int t = rand.nextInt(com.StardewValley.model.Map.farmHeight);
